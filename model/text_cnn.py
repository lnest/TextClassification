...
# File Name: text_cnn
# Edit Author: lnest
# Description：Text CNN clones from https://github.com/dennybritz/cnn-text-classification-tf.git
# ------------------------------------
...
class TextCNN(object):
    ...
    """
    def __init__(
      self, sequence_length, num_classes, char_size, vocab_size, batch_data,
      char_embedding_size, word_embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):

        self.input_x, self.input_y = batch_data
